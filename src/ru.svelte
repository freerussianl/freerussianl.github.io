...
<main>
  ...
  <div>
    <div class="genesis" bind:this={scrollToSections[0]}>
      ...
      <p class="text">
        Free Russia NL - это сообщество русскоязычных жителей Нидерландов. Наше
        сообщество возникло как гражданская инициатива в январе 2021 года. 24
        февраля 2022 года началась полномасштабная война, и жизнь каждого из
        нас, внутри и за пределами России, резко изменилась. В течение месяцев
        войны мы активно действуем, собираем средства для гуманитарной помощи
        Украине и украинским беженцам в Нидерландах, поддерживаем журналистов и
        активистов из России, вынужденных покинуть свою страну, и
        взаимодействуем с голландскими СМИ. В июне 2022 года мы зарегистрировали
        нашу организацию как благотворительную организацию в Нидерландах.
        <br />
        <br />
  ...
  <div bind:this={scrollToSections[6]}>
    ...
    <div class="about">
      <p class="text">
        Если вы представляете СМИ, свяжитесь с нами:
      </p>
